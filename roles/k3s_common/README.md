...
| [Ensure CNI config directory exists](tasks/main.yml#L65) | ansible.builtin.file | False | @docsible Create CNI configuration directory |
| [Ensure CNI bin directory exists](tasks/main.yml#L72) | ansible.builtin.file | False | @docsible Create CNI binaries directory |
| [Ensure K3s agent etc directory exists (for containerd)](tasks/main.yml#L79) | ansible.builtin.file | False | @docsible Create containerd configuration directory |
| [Deploy containerd configuration template](tasks/main.yml#L86) | ansible.builtin.template | False | @docsible Deploy containerd configuration template |
...
classDef rescue stroke:#665352,stroke-width:2px;
  ...
  Configure_K3s_registry_auth6-->|Task| Ensure_CNI_config_directory_exists7[ensure cni config directory exists]:::task
  Ensure_CNI_config_directory_exists7-->|Task| Ensure_CNI_bin_directory_exists8[ensure cni bin directory exists]:::task
  Ensure_CNI_bin_directory_exists8-->|Task| Ensure_K3s_agent_etc_directory_exists__for_containerd_9[ensure k3s agent etc directory exists  for<br>containerd ]:::task
  Ensure_K3s_agent_etc_directory_exists__for_containerd_9-->|Task| Deploy_containerd_configuration_template10[deploy containerd configuration template]:::task
